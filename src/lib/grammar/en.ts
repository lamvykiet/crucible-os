...
/**
 * Tiếng Anh, xếp theo thang CEFR.
 *
 * Khung này đã có từ trước; id của từng điểm giữ nguyên vì id là khoá lưu nội
 * dung bài đã sinh — đổi id là mất sạch bài cũ người dùng đã mở.
 */
export const EN_SYLLABUS: GrammarSyllabus = {
  code: "en",
  scale: "CEFR",
  ...
  references: [
    ...
    "English Grammar in Use (Murphy) — thứ tự giới thiệu thì và động từ khiếm khuyết",
    "Practical English Usage (Swan) — cách chia các chỗ hay dùng sai",
    "A Comprehensive Grammar of the English Language (Quirk et al.) — khung mô tả",
  ],
};
